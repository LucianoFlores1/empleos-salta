...
export default function JobDetails() {
  ...
  if (error || !job) return (
    <div className="text-center py-20 text-muted bg-card rounded-2xl border border-line p-8 shadow-sm max-w-lg mx-auto">
      ...
      <Link to="/" className="inline-flex items-center gap-2 px-6 py-2.5 bg-ink text-white rounded-full text-sm font-semibold hover:bg-ink-strong transition-colors">
  ...
  return (
    ...
    >
      ...
      {copyMsg && (
        <div className="fixed bottom-6 left-1/2 -translate-x-1/2 bg-ink-strong text-white px-4 py-2 rounded-lg shadow-lg text-sm z-50">
